...
/*
 * Common SH-SDHI register definitions.
 *
 * Register definitions shared by Renesas SH-SDHI-compatible hosts.
 *
 * Copyright (C) 2013-2017 Renesas Electronics Corporation
 * Copyright (C) 2008-2009 Renesas Solutions Corp.
 */

#ifndef __SH_SDHI_COMMON_H
#define __SH_SDHI_COMMON_H
